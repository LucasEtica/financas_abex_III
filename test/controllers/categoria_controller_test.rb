...
class CategoriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create categorium" do
    assert_difference("Categorium.count") do
      post categoria_url, params: { categorium: { cor: @categorium.cor, descricao: @categorium.descricao, usuario_id: @categorium.usuario_id } }
    end
  ...
  test "should update categorium" do
    patch categorium_url(@categorium), params: { categorium: { cor: @categorium.cor, descricao: @categorium.descricao, usuario_id: @categorium.usuario_id } }
